...
Tasks:	The project should consist of the following steps: 
Literature review on recent developments within the topic and techniques used in combustion engine cars
Development of central control architecture and implementation on the high end embedded controller (eg. cRIO, DSP.)
Establish CAN communication with rest of the systems 
Developing of and  control unit with load shearing and torque vectoring
Validating performance based on the experimental tests
Student:	Individual project
ECTS:	35
Supervisor:	Nenad Mijatovic, (B325 room 158), nm@elektro.dtu.dk
