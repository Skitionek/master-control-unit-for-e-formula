...
\chapter{Discussion}
As shown in previous chapter for current point in time all measurable characteristics closely follow expected ones however I would like to discuss the current limitations.