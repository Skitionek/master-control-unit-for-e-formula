...
% \include{frontmatter/Acknowledgements} \todo{}
\clearforchapter
\tableofcontents
\clearforchapter
\mylistoftodos
...
\include{chapters/1.2-Defining-the-scope-of-thesis}
\include{chapters/1.3-Outline}
\include{chapters/2-Theory}
\include{chapters/3-Development}
\include{chapters/4-Method}
...
\appendix
\input{appendices/Pumps}
\let\cleardoublepage\clearpage
\input{appendices/Diff}
\let\cleardoublepage\clearpage
\input{appendices/Doc}
